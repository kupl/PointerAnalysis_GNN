...
public interface PointsToAnalysis {
    ...
    /**
     * @param var
     * @return the declaration type of variable var
     */
    ...
    /**
     * @return all reachable application methods in points-to analysis
     */
    Set<Method> applicationMethods();
    ...
    /**
     * @param type
     * @return the set of types which can be assigned to given type
     */
    Set<Type> assignableTypesOf(Type type);
